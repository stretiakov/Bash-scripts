...
**How to run the script:**
  ...
  - Only shift_change.sh needs to be run. It contains a command for starting the primary shiftupdate_funct_4modifnames.sh as well as checks its output in to_email.txt and sends an email if necessary.
